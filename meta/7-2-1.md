...
DATA_COMP: Total Renewable Energy Consumption (in Quadrillion Btu) divided by Total
  Primary Energy Consumption (in Quadrillion Btu), expressed as a percentage
DATA_SOURCE: Maggie Woodward
REC_USE_LIM: ''
SDG_INDICATOR: Renewable energy consumption as a percentage of total final energy
  consumption
SOURCE_TYPE: Energy Information Administration - http://www.eia.gov/totalenergy/data/monthly/
UNIT_MEASURE: Quadrillion Btu
