---
CONTACT_ORGANISATION: 'Educational Technology in U.S. Public Schools: Fall 2008'
DATA_COMP: NCES is estimating the percentages of public schools having these basic
  facilities at 100 percent. There was a survey in 2008 that found that 98 percent
  of public schools had computers for student use. We believe the percentage has increased
  since that date.
DATA_SOURCE: Tom Snyder (and J. Park, 10/2017)
REC_USE_LIM: The values are estimated, but we are quite sure that the actual values
  for all of them approach 100 percent.
SDG_INDICATOR: Percentage of public schools with Internet access for student use.
  Estimated percentage of public schools with basic drinking water, sanitation facilities,
  and hand washing facilities.
SOURCE_TYPE: 'Educational Technology in U.S. Public Schools: Fall 2008 - https://nces.ed.gov/pubsearch/pubsinfo.asp?pubid=2010034'
