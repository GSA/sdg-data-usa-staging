---
CONTACT_ORGANISATION: American Housing Survey
DATA_COMP: '2007-2013:  Using microdata of the American Housing Survey national public
  use files.  Tabulate ZADEQ (recoded adequacy of housing, values ''2'' and ''3'')
  for occupied units (STATUS=''1'') in urban areas (METRO3 IN[''1'',''2'',''4'',''9'']),
...
DATA_SOURCE: David A. Vandenbroucke
REC_USE_LIM: Occupied housing units only.  No group quarters or homeless.  Slums and
  informal housing are not defined.
SDG_INDICATOR: Percentage of occupied housing units in urban areas  that are inadequate
SOURCE_TYPE: American Housing Survey - http://www.census.gov/programs-surveys/ahs.html
UNIT_MEASURE: Percent of all occupied housing units (households)
